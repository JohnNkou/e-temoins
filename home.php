...
<div class="page-wraper">
			...
			<div class="container">
				<div class="header-content">
					...
					<div class="right-content">
						<!-- <a href="notifs.php" class="theme-color">
	...
	<!-- Sidebar -->
    <div class="sidebar">
		<div class="author-box" style="background:#131213">
			<div class="dz-media">
				<img src="img/kurt.jpg" class="rounded-circle" alt="author-image">
			</div>
			<div class="dz-info">
				<span>Témoins Union Sacrée</span>
				<h5 class="name">Kurtis Mak</h5>
			</div>
		</div>
		<ul class="nav navbar-nav">	
			...
			<li>
				...
				<span class="dz-icon light">
					<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#212121" class="bi bi-pass" viewBox="0 0 16 16">
			...
			<li>
				<a class="nav-link" href="notifs.php">
    ...
    <!-- Banner -->
	<div class="banner-wrapper author-notification" style="background:#fb881f">
		<div class="container inner-wrapper">
			<div class="dz-info">
				<span>Témoin Union Sacrée</span>
				<h2 class="name mb-0">Kurtis Mak</h2>
			</div>
			<div class="dz-media media-45 rounded-circle">
				<a href="profil.php"><img src="img/kurt.jpg" class="rounded-circle" alt="author-image"></a>
			</div>
		</div>
	</div>
    <!-- Banner End -->
                ...
                <div class="dashboard-area mt-5">
                        ...
                        <ul class="d-flex align-items-center">
                            <li>
                                <a href="#!" class="btn">
                                    ...
                                    <span style="position: absolute;margin-top: 45px;font-size: .8em;">SOS</span>
                                </a>
                            ...
                            <li>
                                <a href="add.php" class="btn">
                                    ...
                                    <span style="position: absolute;margin-top: 45px;font-size: .8em;">Ajouter</span>
                                </a>
                            </li>
                            <li>
                                <a href="#!" class="btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-clipboard-minus-fill" viewBox="0 0 16 16">
                                    ...
                                    <span style="position: absolute;margin-top: 45px;font-size: .8em;">Afficher</span>
                                </a>
                            </li>
                    ...
                    <div class="features-box">
                        <div class="row m-b20 g-3">
                            <div class="col">
                                <div class="card card-bx card-content" style="background:#434243">
                                    <div class="card-body">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#ffffff" class="bi bi-pass-fill" viewBox="0 0 16 16">
                            ...
                            <div class="col">
                                <div class="card card-bx card-content bg-secondary">
                                    <div class="card-body">
										<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-pass" viewBox="0 0 16 16">
											<path d="M5.5 5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5Zm0 2a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1h-3Z"/>
											<path d="M8 2a2 2 0 0 0 2-2h2.5A1.5 1.5 0 0 1 14 1.5v13a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 14.5v-13A1.5 1.5 0 0 1 3.5 0H6a2 2 0 0 0 2 2Zm0 1a3.001 3.001 0 0 1-2.83-2H3.5a.5.5 0 0 0-.5.5v13a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5v-13a.5.5 0 0 0-.5-.5h-1.67A3.001 3.001 0 0 1 8 3Z"/>
										</svg>
 
                                        <div class="card-info">
                                            <h4 class="title">8K</h4>
                                            <p>Bulletins nuls</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="features-box">
                        <div class="row m-b20 g-3">
                            <div class="col">
                                <div class="card card-bx card-content" style="background:#fb881f">
                                    <div class="card-body">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-box2-fill" viewBox="0 0 16 16">
                            ...
                            <div class="col">
                                <div class="card card-bx card-content" style="background:#2c2054">
                                    <div class="card-body">
    ...
    <!-- Menubar -->
	<div class="menubar-area" style="background:#131213">
		<div class="toolbar-inner menubar-nav">
			...
			<a href="#!" class="nav-link">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#ffffff" class="bi bi-bar-chart-fill" viewBox="0 0 16 16">
				  <path d="M1 11a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3zm5-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V2z"/>

				</svg>
			</a>
			<a href="#!" class="nav-link">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#ffffff" class="bi bi-people-fill" viewBox="0 0 16 16">
