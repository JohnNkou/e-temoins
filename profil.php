    ...
    <div class="sidebar">
		...
		<ul class="nav navbar-nav">	
			...
			<li>
				...
				<span class="dz-icon light">
					<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#4e4f51" class="bi bi-people-fill" viewBox="0 0 16 16">
        ...
        <div class="content-body fb">
            ...
            <div class="container company-detail">
                <div class="media media-60">
                    <img src="img/kurt.jpg" style="border-radius: 100px;">
                </div>
                <div class="detail-content">
                    <div class="flex-1">
                        <h4>Kurtis Mak</h4>
                        <p>Témoins Union Sacrée</p>
                    </div>
                    <div class="text-end">
                ...
                <ul class="contact-box">
                    ...
                    <li class="d-flex align-items-center my-3">
                        ...
                        <div class="ms-3">
                            ...
                            <h6><a href="javascript:void(0);">highspeedst@gmail.com</a></h6>    
                        </div>
                    </li>
                    <li class="d-flex align-items-center">
                        <a href="javascript:void(0);" class="contact-icon">
                        ...
                        <div class="ms-3">
                            <p class="mb-2">Localisation</p>    
                            <h6><a href="javascript:void(0);">Kinshasa</a></h6>    
                        </div>
                    </li>
                </ul>
                <div class="about-company">
                    <h5>Bio</h5>
                    <p>
                       Je suis dynamique et efficace. Je possède un bon esprit analytique, d’anticipation, de capacité de communication, d’administration, de management des affaires publiques et privées, de travail d’équipe. 
                    </p>
                    <p>
                        Dans un contexte de stress, j’ai toujours eu la bonne attitude. Dans tout ce que j’entreprends professionnellement, je m’implique avec vigueur et assiduité. J’ai une solide capacité d’adaptation et d’organisation.
                    </p>
                </div>
            </div>
		</div>    
