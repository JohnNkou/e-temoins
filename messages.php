    ...
    <div class="page-content fb">
        <div class="container pb-0"> 
            <div class="input-group input-search">
                ...
                <input type="text" id="myInput" placeholder="recherche" class="form-control bs-0 ps-0">
            </div>
        </div>
        <div class="container pt-0">
            ...
            <ul class="dz-list message-list">
                <li>
                    <a href="chat.php">
                        <div class="media media-45 rounded-circle">
                            <img src="assets/images/message/pic1.jpg" alt="image">
                        </div>
                ...
                <li>
                    <a href="chat.php">
                        <div class="media media-45 rounded-circle">
                            <img src="assets/images/message/pic3.jpg" alt="image">
                        </div>
                        <div class="media-content">
                            <div>
                ...
                <li>
                    <a href="chat.php">
                        <div class="media media-45 rounded-circle">
                            <img src="assets/images/message/pic4.jpg" alt="image">
                        </div>
                        <div class="media-content">
                            <div>
                ...
                <li>
                    <a href="chat.php">
                        <div class="media media-45 rounded-circle">
                            <img src="assets/images/message/pic5.jpg" alt="image">
                        </div>
                        <div class="media-content">
                            <div>
            ...
            <a href="javascript:void(0);" class="btn scrollTop btn-primary btn-rounded px-3 chat-btn w-50">
