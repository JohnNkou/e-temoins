			            ...
			            <a href="index.html" className="brand-logo">
							<svg className="logo-abbr" width="66.5px" height="66.5px">
								<g><path className="svg-logo-circle" fillRule="evenodd"  fill="rgb(64, 24, 157)"
								 d="M32.999,66.000 C14.774,66.000 -0.000,51.225 -0.000,33.000 C-0.000,14.775 14.774,-0.000 32.999,-0.000 C51.225,-0.000 66.000,14.775 66.000,33.000 C66.000,51.225 51.225,66.000 32.999,66.000 Z"/></g><g><path className="svg-logo-icon-text" fillRule="evenodd"  stroke="rgb(255, 255, 255)" strokeWidth="1px" strokeCap="butt" strokeJoin="miter" fill="rgb(255, 255, 255)"
							...
							<path className="svg-logo-text-path" fillRule="evenodd"  stroke="rgb(0, 0, 0)" strokeWidth="1px" strokeCap="butt" strokeJoin="miter" fill="rgb(64, 24, 157)"
			                            ...
			                            <li className="nav-item dropdown header-profile">
			                                ...
			                                <div className="dropdown-menu dropdown-menu-end">
			                                    <a href="app-profile.html" className="dropdown-item ai-icon">
			                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" className="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeCap="round" strokeJoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
			                                        <span className="ms-2">Profile </span>
			                                    </a>
			                                    <a href="email-inbox.html" className="dropdown-item ai-icon">
			                                        <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" className="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeCap="round" strokeJoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
			                                        <span className="ms-2">Inbox </span>
			                                    </a>
			                                    <a href="page-login.html" className="dropdown-item ai-icon">
			                                        <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" className="text-danger" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeCap="round" strokeJoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
							...
							<ul className="metismenu" id="menu">
			                    <li className="has-menu"><a className="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
			                        ...
			                        <ul aria-expanded="false">
										...
										<li><a href="/admin/candidats">Candidats</a></li>
										<li><a href="/admin/temoins">Temoins</a></li>
